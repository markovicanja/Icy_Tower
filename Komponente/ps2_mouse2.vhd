...
ARCHITECTURE logic OF ps2_mouse2 IS
...
BEGIN
	...
	ps2_transceiver_0:  ps2_transceiver2
	GENERIC MAP(clk_freq => clk_freq, debounce_counter_size => ps2_debounce_counter_size)
	PORT MAP(clk => clk, tx_ena => tx_ena, tx_cmd => tx_cmd, tx_busy => tx_busy,
				ps2_code => ps2_code, ps2_code_new => ps2_code_new, ps2_clk => ps2_clk, ps2_data => ps2_data);
			...
			CASE state IS
				...
				WHEN stream =>
					...
					--uslov13
						...
						END IF;
					END IF;
					--kako je moguce da se desi da ps2_code_new_prev i ps2_code_new budu 1 u istom taktu
